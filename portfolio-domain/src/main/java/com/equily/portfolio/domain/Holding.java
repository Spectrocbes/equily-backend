...
public record Holding(
    ...
    public static Optional<Holding> computeFrom(
        ...
        BigDecimal weightedCostSum = BigDecimal.ZERO.setScale(MONEY_SCALE + QUANTITY_SCALE, RoundingMode.HALF_EVEN);
        ...
        for (Transaction t : transactions) {
            if (t.type() == TransactionType.BUY) {
                ...
                // weightedCostSum is preserved; averageCostPrice will be recalculated from totalBoughtQty below.
            }
        }
        ...
        BigDecimal avgCostAmount = totalBoughtQty.compareTo(BigDecimal.ZERO) == 0
        ...
        return Optional.of(new Holding(ticker, assetType, metadata, totalQty, averageCostPrice, totalInvested));
    }
}
